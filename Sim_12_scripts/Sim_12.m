...
%
% This simulation uses the gaussian wild bootstrap in SSS for the methods comparison in Section 4.1 of the manuscript
% Dimension: 2D
% Signal: Circle
% Noise: Homogeneous (Standard Devation 1)
%
