...
% Determinant notes
%
% The determant of a symmetric 3x3 matrix A with entries
%     a11 a12 a13
%     a12 a22 a23
%     a13 a23 a33
% can be written
%     a11*a22*a33 + 2*a23*a13*a12 - a11*a23^2 - a22*a13^2 - a33*a12^2
% where the order is chosen so that last three terms can be an inner
% product between the diagonal of A and a vector [ a23 a13 a33 ].
%
