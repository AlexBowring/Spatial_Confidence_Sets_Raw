...
% Bias correction
% Variable 'resel' is unbiased and is actual quantity that really
% matters for RFT P-values, but only FWHM gets returned. This bias
% correction ensures that prod(1./FWHM) equals resel. 
